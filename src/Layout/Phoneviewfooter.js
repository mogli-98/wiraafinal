...
export default function Phoneviewfooter() {
    ...
    return (
        <>
            ...
            <Card className='d-block d-sm-none' style={{height:'60px',position: 'fixed', bottom: 0, width: "100%", padding:'10px',border: 'none', marginTop: '10px', boxShadow: '2px 4px 4px #9E9E9E', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                ...
                <Container>
                    ...
                    <Row>
                        ...
                        <Col xs={3}>
                            ...
                            <svg style={{marginLeft:'20px'}}  xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-house" viewBox="0 0 16 16">
                        ...
                        <Col xs={3}>
                            <Link to="/Order">
                            <svg style={{marginLeft:'20px'}}  xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-send" viewBox="0 0 16 16">
                        ...
                        <Col xs={3}>
                            ...
                            <Link to="/Message">
                            <svg style={{marginLeft:'20px'}} xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-envelope" viewBox="0 0 16 16">
                        ...
                        <Col xs={3}>
                            <img onClick={handleShow} style={{ width: '30px', height: '30px', borderRadius: '50%',marginLeft:'20px' }} src={Profile} alt="PROFILE" />
                            ...
                            <CDBSidebarContent className="sidebar-content">
                                <CDBSidebarMenu>
                                    ...
                                    <CDBSidebarMenuItem className="text-dark ">
                                        ...
                                        <Card style={{ padding: '6px', marginTop: '70px',border:'none',width:'90%',boxShadow: '0px 0px 10px 5px rgba(192, 192, 192, 0.5)'}}>
                                            <center>
