...
function FreeLearn() {
     ...
     const checkoutHandler = async (amount, currency) => {
          ...
          const { data: order } = await axios.post("https://wiraaback.azurewebsites.net/api/v1/payment/paymentCheckout ",
               formData
          )
          console.log(typeof (order?.r[0]?.order?.amount), 'order')
          const options = {
               key: 'rzp_test_s2YXwAnpkbafZB',
               ...
               email: 'wiraa@gmail.com',
               name: "Wiraa",
               affiliateId: order?.r[0]?.AffiliateId,
               ...
               handler: async function (response) {
                    ...
                    const callback_url = await axios.post("https://wiraaback.azurewebsites.net/api/v1/payment/paymentVerification", data, {
                         headers: {
                                   ...
                                   <Row >
                                        <Col sm={8} className='scrollable squarew '  >
                                             ...
                                             <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                                                  ...
                                                  <p>
                                                       <span style={{ float: "right", marginRight: '20px' }}> 11,222 student</span>
                                                  </p>
                                             ...
                                             <Card className='  mb-4 shadow-2 d-none d-sm-block ' style={{ position: 'fixed', top: '20px', width: '20%', marginTop: '80px', boxShadow: '0 14px 26px -12px rgb(14 4 3 / 42%), 0 4px 23px 0px rgb(0 0 0 / 12%), 0 8px 10px -5px rgb(53 15 13 / 20%)', borderStyle: 'none' }}>
                                                  ...
                                                  <div className='d-none d-sm-block' >
                                                       <center>
                                                            ...
                                                            <button style={{ height: '35px', width: '160px', marginBottom: "40px", marginRight: '80px' }} className='model-button' onClick={() => checkoutHandler("5000", "INR")}> Buy Now</button>
                                                       </center>
                                                  </div>
                                                  ...
                                                  <div className='d-block d-sm-none mb-5' >
                                                       <div className='p-2' style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', backgroundColor: 'ButtonHighlight' }} >
                                                            ...
                                                            <button style={{ height: '35px', fontSize: '18px' }} className='model-button' onClick={() => checkoutHandler("5000", 'INR')}> Buy Now</button>
                                                       </div>
                                                  </div>
