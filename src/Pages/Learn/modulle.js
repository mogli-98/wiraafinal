                        ...
                        <Container className='square border border-bottom-0'>
                            ...
                            <Row >
                                <Col sm={8} className='scrollable squarew '  >
                                    <h4 style={{ padding: "15px", fontSize: "27px" }}>{courseList?.[0]?.CourseTitle}</h4>
                                    ...
                                    <div className=''>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="20" fill="currentColor" className="bi bi-globe2" viewBox="0 0 16 16" style={{ marginLeft: "18px", marginRight: "5px", color: "grey" }}>
                                        ...
                                        </svg> <span style={{ color: "grey", fontSize: "16px", fontWeight: "600" }}>English</span>

                                        <span style={{ float: "right" }}> 11,222 student<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-person-heart" viewBox="0 0 16 16">
                                    ...
                                    <p className='mt-4' style={{ fontSize: "18px", paddingLeft: "28px" }}><b>Course Include :</b></p>
                                    <Row>
                                        <Col>
                                            <ul>
                                    ...
                                    <p className='mt-1' style={{ fontSize: "18px", paddingLeft: "28px",fontWeight:"600" }}>Course Content :</p>
                                    <Accordion flush>
                                    ...
                                    <div ><img src={Test} alt="" style={{ height: "13vh", borderRadius: '50%', width: "13vh" }} /> <span>{courseList?.[0]?.AuthorName}</span>

                                        <span>{courseList?.[0]?.AuthorDescription}</span>
                                ...
                                <Col sm={4} >
                                    <Card className='mt-2 shadow-2' style={{boxShadow: '0 14px 26px -12px rgb(14 4 3 / 42%), 0 4px 23px 0px rgb(0 0 0 / 12%), 0 8px 10px -5px rgb(53 15 13 / 20%)' ,borderStyle:'none'}}>
                                    <img src={model} alt="" style={{ width: "100%" }} className='p-2' />
                                    <ul style={{ listStyle: "none" }}>
                                        <p style={{ fontSize: '16px', fontWeight: 600, color: 'black' }}> <b>This Course includes : </b>  </p>
                                    ...
                                    <p className='text-center'> <span className='text-center' style={{ fontSize: '20px', color: '#008080' }}> <b style={{ marginRight: '20px' }}>₹1999</b> </span>  <span className='text-center pricing-tableli' style={{ fontSize: '20px', color: 'Black' }}> <b style={{ color: '#008080' }}>₹4999 </b>   </span></p>
                                    <button style={{ height: '35px', width: '160px',marginBottom:"10px" }} className='model-button '> Buy Now</button>
                                    </Card>
                                </Col>
                            </Row>
                        </Container>
