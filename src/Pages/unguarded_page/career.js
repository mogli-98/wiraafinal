      ...
      <div style={{ backgroundColor: 'white' }}>
        ...
        <center>
          <div className="career_container">
            ...
            <center>
              <h2 className="career-h2 mb-4">Build The Future. Come Work With Us!</h2>
            </center>
        ...
        {/* <div className="container1">
          <div className="row">
            <div className="col-sm-6 career_la">
              ...
              <center>
                <h4 className="career-h2" style={{marginTop:'160px'}}>Our diverse and dynamic teams work collaboratively to bring innovative educational
                  services and ideas to life.</h4>
              </center>
