                                    ...
                                    <Col sm={8} className="project square border-end border-start">
                                        ...
                                        <div className='m-3 '>
                                                ...
                                                <span style={{fontSize:'12px',fontWeight:600}}>
                                                    ...
                                                    <svg style={{color:'grey',marginRight:'5px',paddingRight:'4px'}} xmlns="http://www.w3.org/2000/svg" width="21" height="21" fill="red" className="bi bi-star order-details-shortlisted" viewBox="0 0 16 16">
