...
function FreeProjectdetails() {
  ...
  useEffect(() => {
    ...
    ProjectModal.getPrjectdetails({ projectId })
      .then((respone) => {
  ...
  const Markfav = async (id) => {
    ...
    const projectId = id;
    ProjectModal.getMarkfavproject({ userId, projectId })
      .then((response) => {
      ...
      <Container fluid className="dashboard-conatiner-top">
            ...
            <Container className="square border border-bottom-0">
              ...
              <Row>
                <Col
                  sm={8}
                  style={{ padding: "0px" }}
                  className="project square border-end border-start"
                >
                  <div className="mt-3">
                    {orderdetails?.[0]?.Status == "Closed" ? (
                      <>
                        ...
                        <div
                          style={{ marginTop: "80px", padding: "0px 20px" }}
                      ...
                      <>
                        ...
                        >
                          ...
                          <svg
                            ...
                            height="21"
                            fill="red"
                            className="bi bi-star order-details-shortlisted"
                            viewBox="0 0 16 16"
                            onClick={() => {
                              Markfav(params.id);
                            }}
                    ...
                    <Card
                      ...
                      style={{
                        ...
                        borderRadius: "15px",
                        border: "none",
                        boxShadow: "0px 0px 10px 5px rgba(192, 192, 192, 0.5)",
                      }}
                    >
                    ...
                    <Table borderless>
                      <tbody>
                        <tr>
                          ...
                          <td className="right-td text-success">
                            <b>{orderdetails?.[0]?.Status}</b>
                          </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          ...
                          <td className="right-td">
                            <b>
                              {moment(orderdetails?.[0]?.ApplyDate).format(
                                "DD-MM-YYYY"
                              )}
                            </b>
                          </td>
                        ...
                        <tr>
                          ...
                          <td className="right-td">
                            <b>
                              {moment(orderdetails?.[0]?.DueDate).format(
                                "DD-MM-YYYY"
                              )}
                            </b>
                          </td>
        ...
        >
          <Modal.Header closeButton>
            <Modal.Title style={{ color: "#008080" }}>
              Screening Questions Gou
            </Modal.Title>
          </Modal.Header>
          <form onSubmit={handleSubmit}>
            <Modal.Body>
              <Card style={{ margin: "10px" }}>
                <h6 style={{ marginTop: "6px", marginLeft: "10px" }}>
                  Q.How many year of experience do you have this feild?
                </h6>
              ...
              <Card style={{ margin: "10px" }}>
                <h6 style={{ marginTop: "6px", marginLeft: "10px" }}>
                  Q.Are you comfortable with my project budge?{" "}
                </h6>
...
"
                  ...
                  <input
                    ...
                    type="radio"
                    name="comfortable"
                    value="First i want to understand the project
"
                  />{" "}
                  <span style={{ marginLeft: "10px", fontWeight: 500 }}>
...
"
              ...
              <Card style={{ margin: "10px" }}>
                <h6 style={{ marginTop: "6px", marginLeft: "10px" }}>
                  Q.We must fill this position urgently. Can you start
                  immediately?
                </h6>
...
"
                  ...
                  <input
                    ...
                    type="radio"
                    name="availabality"
                    value="I can start from next week
"
                  />{" "}
                  <span style={{ marginLeft: "10px", fontWeight: 500 }}>
                  ...
                  <input
                    ...
                    type="radio"
                    name="availabality"
                    value="I can start from next month
"
                  />{" "}
                  <span style={{ marginLeft: "10px", fontWeight: 500 }}>
                    I can start from next month
                  </span>
                </div>
              </Card>
            </Modal.Body>
