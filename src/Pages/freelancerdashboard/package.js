...
function Package() {
    ...
    const displayRazorepay = async (amount) => {
        const res = await loadScript('https://checkout.razorpay.com/v1/checkout.js')
        if (!res) {
            alert('You are Offline ... Failed to laod.....')
            return
        }

        const options = {
            kye: 'rzp_test_Yz4R3EJBOM',
            currency: 'INR',
            amount: amount * 100,
            name: 'pay done',
            Secret: "yicjkkBKcTNVtHXy1265FRyn",
            description: 'amout done',
            // image: 'https://mern-blog-akky.herouapp.com/media/logo.8c649bfa.png',
