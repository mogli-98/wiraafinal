                                        ...
                                        <Form.Group className="mb-2" controlId="exampleForm.ControlInput1">
                                            ...
                                            <div>
                                                <Card style={{ backgroundColor: "#efefef", border: 'none', display: 'flex', justifyContent: 'center' }}>
                                                    <p className='m-2' style={{ fontSize: '16px', marginLeft: '20px' }}>  Update your latest image  <span>

                                                        <Button style={{ color: 'white', width: '100px', backgroundColor: '#008080', border: 'none', float: 'right', fontWeight: 500 }} class="- btn">
                                                            Upload
                                        ...
                                        <Row>
                                            <Col sm={6}>
                                                    ...
                                                    <Form.Control placeholder="Your Name"
                                                     className='formborder' style={{ paddingLeft: '20px', fontSize: '17px' }} />
                                            ...
                                            <Form.Control   onChange={handleInputChange} as="textarea" name='aboutMe' rows={3} placeholder="Please enter a headline" className='formborder' style={{ paddingLeft: '20px', fontSize: '17px' }} />
