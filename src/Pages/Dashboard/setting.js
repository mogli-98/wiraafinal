...
function Setting() {
    ...
    helper.sweetalert
      ...
      .then((result) => {
        if (result.isConfirmed) {
          ...
          SettingModal.accdeactive({ userId })
            .then((response) => {
  ...
  const CheckEmailUdation = (event) => {
    ...
    SettingModal.Checkemail(userId, form)
      .then((respnse) => {
  ...
  const blockuser = () => {
    ...
    SettingModal.Blocklist({ userProfileId })
      .then((respnse) => {
        console.log(respnse.data);
        setBlockuserlist(respnse.data);
        handleShow2(true);
  ...
  const unblockuser = (UserID) => {
    const userProfileId = localStorage.getItem("userProfileId");
    const userId = UserID;
    SettingModal.Unblockuser({ userProfileId, userId })
      .then((respnse) => {
      ...
      <Container fluid className="dashboard-conatiner-top">
        <Row>
          ...
          <Col
            ...
            sm={8}
            xs={12}
            className="dashboard-conatiner-top-row  d-none d-sm-block"
          >
                  ...
                  >
                    <div className="m-1 setting-text">
                      ...
                      <p
                        ...
                        className=""
                      >
                        Upload Email address of your account{" "}
                      </p>
                    </div>
                  </Card>
                </Col>
                  ...
                  >
                    <div className="m-1 setting-text">
                      ...
                      <p
                        ...
                        className=""
                      >
                        Upload Phone number in case you have trouble signing in
                      </p>
                    </div>
                  </Card>
                </Col>
                  ...
                  >
                    <div className="m-1 setting-text">
                      ...
                      <p
                        ...
                        className=""
                      >
                        Temporarily deactivate your Wiraa account
                      </p>
                    </div>
                  </Card>
                </Col>
                  ...
                  >
                    <div className="m-1 setting-text">
                      ...
                      <p
                        ...
                        className=""
                      >
                        Choose a strong password that you are not using anywhere
                      </p>
                    </div>
                  </Card>
                </Col>
          ...
          <Col
            ...
            sm={8}
            xs={12}
            className="dashboard-conatiner-top-row d-block d-sm-none "
          >
            <Container className="square border border-bottom-0">
              <Topnav activeLink="Setting" />
            ...
            <div>
              <form onSubmit={CheckEmailUdation}>
                ...
                >
                  ...
                  <Form.Control
                    required
                    placeholder="Please enter your update Email"
                    name="email"
