...
function Explorepage() {
  ...
  useEffect(() => {
    ...
    PeopleModal.userProfile({ userProfileId }, { searchUserId })
      .then((response) => {
                ...
                <Col className="square border-end" sm={8}>
                  <div
                    style={{
                      ...
                      borderBottomRightRadius: "370px 370px",
                    }}
                  >
                    <Card
                      className="order-detail-profile"
                      style={{
                        backgroundColor: "#efefef",
                        border: "none",
                        borderRadius: "35px",
                    ...
                    >
                      ...
                      <center>
                        ...
                        <h6 style={{ fontSize: "20px" }} className="mt-2">
                          <b>
                            {MyDetails?.[0]?.FirstName}{" "}
                            {MyDetails?.[0]?.LastName}{" "}
                          </b>
                        </h6>
