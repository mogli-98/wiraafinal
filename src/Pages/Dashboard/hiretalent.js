...
//                                                                 <label>
//                                                                     <input type="radio" name="serviceMode" className="card-input-element"
//                                                                     />

//                                                                     <div style={{ padding: '6px 20px', borderRadius: '6px', fontWeight: 500, border: '1px solid grey ' }} className="panel panel-default card-input">
...
//                                                                 <label>
//                                                                     <input type="radio" name="duration" className="card-input-element" />
...
function Hiretalent() {
    ...
    const handleSubmit = (event) => {
        ...
        Auth.PostRequest(formdata)
            .then((response) => {
                console.log(response.data, "yes data update");
                helper.sweetalert.toast2("Your order request is under review.", 'Your order request is under review.')
                window.location.replace("/Order")
            })
            .catch((error) => {
                console.log(error);
                                ...
                                <Col sm={8} className="square border-end ">
                                    ...
                                    <form className='m-2' onSubmit={handleSubmit} >
                                        ...
                                        <Row>
                                            ...
                                            <Col sm={6} xs={6}>
                                                <Form.Control className='form-control-lg' style={{ border: '2px solid lightgrey', fontSize: '16px' }} type="tel" placeholder="Phone Number"
                                                    required
                                                    name='mobile'
                                                //    maxLength={10}
                                                //    inputMode="numeric"
                                                //    pattern="[0-9]*" 
                                                   ...
                                                   onChange={(e) => {
                                                    ...
                                                    const truncatedMobileNumber = numericValue.slice(0, 10);
                                        ...
                                        <Form.Group className="mb-3 mt-4" controlId="exampleForm.ControlTextarea1">
                                            ...
                                            <Row>
                                                ...
                                                <Col sm={3} xs={6}>
                                                    <input className='form-control-lg' type="tel" placeholder='e.g 10000'
required
                                                        style={{
                                                            borderRadius: '5px', border: '2px solid lightgrey',
                                                            width: "-webkit-fill-available"
                                                ...
                                                <Col sm={1} xs={12}><p className='mt-2' style={{ fontSize: '18px' }}>to</p></Col>
                                                <Col sm={3} xs={6}>
                                                    <input required className='form-control-lg' type="tel" placeholder='e.g 20,000' style={{
                                                        borderRadius: '5px', border: '2px solid lightgrey',
                                                        width: "-webkit-fill-available"
                                                        , height: "40px", fontSize: '16px'
                                                    }}
