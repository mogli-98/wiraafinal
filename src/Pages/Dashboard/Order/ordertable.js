        ...
        if (row.ApprovalStatus === "Approved") {
          return (
            <>
              ...
              >
                <Link to={`/Orderdetailsbreief/${row.PostreqID}`}>
                  {row.Title}
                </Link>{" "}
              </div>
            </>
          ...
          >
                  ...
                  <Card className="dashboradfree-card-top mt-3">
                    <div className="dashboradfree-card-top-div">
                      <Link style={{ color: "#008080" }} to="/Hiretalent">
                        <button
                          style={{ marginLeft: "30px", padding: "4px 35px" }}
                          className="freedashboard-create"
                        >
                          Post a request
                        </button>
                      </Link>
                      ...
                      <img
                        src={orderpost}
                        alt=""
                        className="freedashboard-top-img"
                      />
                      <p>
            ...
            <Row>
              ...
              >
                <Col xs={12}>
                  {oederTable.length > 0 &&
                    oederTable.map((tableitem, index) => (
                      <Link
                      ...
                      >
                        ...
                        >
                          <h5>
                            {tableitem?.Category} - {tableitem.SubCategory}
                          </h5>
                          ...
                          >
                            <p style={{ color: "grey" }}>
                              {tableitem.Currency} {tableitem.Budget}
                            </p>
                            <p style={{ color: "grey" }}>
                              {" "}
                              <svg
                              ...
                              {moment(tableitem.ApplyDate).format("DD/MM/YYYY")}
                            </p>
                          </div>
                        </Card>
                      </Link>
